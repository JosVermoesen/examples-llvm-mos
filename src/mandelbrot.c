...
int xreg1(char device, char channel, unsigned char address, unsigned v0)
{
    RIA.xstack = device;
    RIA.xstack = channel;
    RIA.xstack = address;
...
int xreg2(char device, char channel, unsigned char address, unsigned v0, unsigned v1)
{
    RIA.xstack = device;
    RIA.xstack = channel;
    RIA.xstack = address;
...
int xreg3(char device, char channel, unsigned char address, unsigned v0, unsigned v1, unsigned v2)
{
    RIA.xstack = device;
    RIA.xstack = channel;
    RIA.xstack = address;
...
int xregnn(char device, char channel, unsigned char address, unsigned count,
           ...)
{
    va_list args;
    va_start(args, count);
